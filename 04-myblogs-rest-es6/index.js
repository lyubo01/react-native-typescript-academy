import { addNewPost, getAllPosts, deleteThePost } from './blogs-api-client.js';
...
export function addPost(post) {
  ...
  postElem.innerHTML = `
    ...
    <div class="card-action">
      <button class="btn waves-effect waves-light light-blue darken-1" type="button" id="edit">Edit
